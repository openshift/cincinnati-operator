...
type UpdateServiceSpec struct {
	...
	// graphDataImage is a container image that contains the Update
	// Service graph data.
	// +kubebuilder:validation:Required
...
const (
	...
	// ConditionRegistryCACertFound reports whether the registry CA cert had been found.
	ConditionRegistryCACertFound conditionsv1.ConditionType = "RegistryCACertFound"
)

// +kubebuilder:object:root=true
// +kubebuilder:subresource:status
// +kubebuilder:resource:path=updateservice,scope=Namespaced

// UpdateService is the Schema for the UpdateService API.
...
// UpdateServiceList contains a list of UpdateServices.
